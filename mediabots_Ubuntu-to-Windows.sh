...
link1_status=$(curl -Is https://www.dropbox.com/s/683fb7m27gxby1l/Windows10_Lite_V2.iso?dl=1 | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://www.dropbox.com/s/683fb7m27gxby1l/Windows10_Lite_V2.iso?dl=1 | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://archive.org/download/WS2012R2/WS2012R2.ISO # Windows Server 2012 R2 
if [ $link1_status = "2001" ] ; then 
	...
	sudo wget -P /mediabots https://www.dropbox.com/s/683fb7m27gxby1l/Windows10_Lite_V2.iso?dl=1
else
